...
def showCategories():
    ...
    items = session.query(Item).group_by(Item.category_id).order_by(desc(Item.created_date)).all()
    print(items)
...
def newCategory():
    ...
    if request.method == 'POST':
        ...
        flash('New Category %s Successfully Created' % newCategory.name, 'newCategory')
        session.commit()
...
def newItem(category_id):
    ...
    if login_session['user_id'] == newItemInCate.user_id:
        ...
        flash("You are not authorized to add an item in the selected category!",'notAuthorized')
        return redirect(url_for('showACategory',category_id=category_id))
...
def editItem(category_id, item_id):
    ...
    if login_session['user_id'] == editedItem.user_id:
        ...
        flash("You are not authorized to edit the selected item!",'notAuthorized')
        return redirect(url_for('showACategory',category_id=category_id))
...
def deleteItem(category_id, item_id):
    ...
    if login_session['user_id'] == deletedItem.user_id:
        ...
        flash("You are not authorized to delete the selected item!",'notAuthorized')
        return redirect(url_for('showACategory',category_id=category_id))
